...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        primaryColor: Color(0xFF556B2F), // Dark Olive Green
    ...
    return Scaffold(
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            // Row to hold the text, wrench icon, and auto text
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                // "Diagnostic" Text
            ...
            SizedBox(height: 16), // Space below the icons
            // Grid of Status Cards
            Expanded(
              child: GridView.count(
                crossAxisCount: 3, // 3 items per row
                childAspectRatio: 1.2, // Adjusted to fit more items
                children: [
                  ...
                  _buildStatusCard(FontAwesomeIcons.exclamationTriangle, "Les codes défauts", "p0420"), // 7th option
                ],
              ),
            ),
          ],
